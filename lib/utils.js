...
function createJWT() {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _jsonwebtoken2.default.sign((0, _lodash6.default)(payload, VALID_KEYS), secret, (0, _lodash4.default)(settings, VALID_KEYS), function (error, token) {
      if (error) {
...
function verifyJWT(token) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    _jsonwebtoken2.default.verify(token, secret, (0, _lodash4.default)(settings, VALID_KEYS), function (error, payload) {
      if (error) {
